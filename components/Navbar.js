            ...
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="hidden md:flex space-x-4 items-center">
                    ...
                    <div className='flex items-center'>
                        ...
                        <Button className="mx-1 cursor-pointer" variant="default">Signup</Button>
                        <ModeToggle />
                    </div>
                </div>
                            ...
                            <SheetHeader>
                                ...
                                <SheetDescription>
                                    <div className="flex flex-col gap-6">
                                        ...
                                        <div>
                                            <Button className="mx-1 cursor-pointer text-xs" variant="outline">Login</Button>
                                            <Button className="mx-1 cursor-pointer text-xs" variant="default">Signup</Button>
