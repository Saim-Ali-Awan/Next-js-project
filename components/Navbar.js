      ...
      <section className="container px-4 py-10 mx-auto lg:h-128 lg:space-x-8 lg:flex lg:items-center dark:bg-[#101828]">
        <div className="w-full text-center lg:text-left lg:w-1/2 lg:-mt-8">
          <h1 className="text-3xl leading-snug text-gray-800 dark:text-gray-200 md:text-4xl">
            A <span className="font-semibold">School Student</span>  <br className="hidden lg:block" /> Saim Ali <span className="font-semibold underline decoration-primary"><span ref={el} /></span>
          </h1>
          <p className="mt-4 text-lg text-gray-500 dark:text-gray-300">
            A Full stack Web Developer from Pakistan. <br className="hidden lg:block" /> Contact me if you want me to build sites.
          </p>
    ...
    <div className="flex flex-wrap justify-center">
      ...
      <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
        <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105 text-center">
          ...
          <Button className="mx-1" variant="outline" onClick={handleButtonClick}>Choose Plan</Button>
        </div>
      </div>
      {/* Standard Plan */}
      <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
    ...
    <div className="flex flex-wrap justify-center">
      ...
      <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
        <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQV1o2fA2Hp8xMMgSh4uH7LeH30Gud9c9pJlA&s" className="w-full h-64 object-cover rounded-t-lg"/>
          <div className="mt-4">
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200">Learn Typscript</h3>
            <p className="mt-2 text-gray-600 dark:text-gray-400">Learn typescript with me it is a very commonly used programming syntax.</p>
      ...
      <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
        <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105">
          ...
          <div className="mt-4">
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200">Learn AI</h3>
            <p className="mt-2 text-gray-600 dark:text-gray-400">Learn Ai with me.</p>
      ...
      <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
        <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105">
          ...
          <div className="mt-4">
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200">Typing</h3>
            <p className="mt-2 text-gray-600 dark:text-gray-400">Experts say that you can save about 21 days if you type fast.</p>
